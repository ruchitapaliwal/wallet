...
public class Testbackbutton {
	WebDriver driver;
  @Test
  public void backbutton() throws InterruptedException, EncryptedDocumentException, IOException {
	  ...
	  driver=Baseclass.Nivapay_Wallet_launch(0, 0, null);	
		...
		Thread.sleep(5000);
		b1.clickonback();
		Reporter.log("when user click on backbutton from transfer screen");
		Thread.sleep(5000);
		b1.backtodashbaoard();
		Thread.sleep(5000);
		driver.close();
